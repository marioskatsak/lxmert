...
class ROSMIModel(nn.Module):
    def __init__(self):
        ...
        self.dist_float.apply(self.lxrt_encoder.model.init_bert_weights)
    ...
    def forward(self, feat, feat_mask, pos, names, sent):
        ...
        distance = self.dist_float(feat_seq[0][:,0])
        ...
        return distance, (dist_s,dist_e, landmark_,cland_, bearing_,start_logits,end_logits)
